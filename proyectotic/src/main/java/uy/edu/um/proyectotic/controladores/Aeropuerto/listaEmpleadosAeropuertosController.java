...
@Controller
@FxmlView("listaEmpleadosAeropuerto.fxml")
public class listaEmpleadosAeropuertosController {
    ...
    void atras(ActionEvent event) {
        configuraciones.cambiarPantalla(botonParaAtaras.getScene(), vistaAeropuertoController.class,applicationContext);
    }
